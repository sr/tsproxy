...
func dnsSolver(ca *acmetest.CAServer) DNS01ChallengeSolver {
	return func(ctx context.Context, domain, record string) (func() error, error) {
		ca.PutDNSResponse(domain, record)
