...
// Package autocert is a fork of golang.org/x/crypto/acme/autocert with support for
// DNS-01 adapted from https://go-review.googlesource.com/c/crypto/+/381994.
//
...
type Manager struct {
	...
	// Sesolver is used to respond to dns-01 challenges returned from the CA.
...
func (m *Manager) fulfill(ctx context.Context, client *acme.Client, chal *acme.Challenge, domain string) (cleanup func(), err error) {
	...
	case "dns-01":
		...
		cleanup, err := m.DNS01(ctx, domain, rec)
		if err != nil {
			return nil, err
		}
		return func() { _ = cleanup() }, err
	}
